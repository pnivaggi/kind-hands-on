...
## Task 3. Define Kubernetes Cluster config file
...
## Task 5. Check the cluster with Kind CLI
...
## Task 6. Check Kubectl config and current context
...
## Task 7. Check the cluster with Kubectl
...
## Task 8. Check the cluster with Docker
...
## Task 9. Check the Pods already deployed
